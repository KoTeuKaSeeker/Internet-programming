    ...
    <div class="navigationContainer">
        <nav class="navigation">
            <ul>
                ...
                <li> <button class="headerButton jetBrainsFont navigationFont" onClick="document.location = 'contact.php'">Контакты</button></li>
                <li> <button class="headerButton jetBrainsFont navigationFont" onClick="document.location = 'projects.php'">Проекты</button></li>
                <li> <button class="headerButton jetBrainsFont navigationFont" onClick="document.location = 'game.php'">Игра</button></li>
